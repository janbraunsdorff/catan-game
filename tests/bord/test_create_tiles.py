...
from catan.board.types import NODE_TYPE, TILE_TYPE
...
def test_create_filed_1():
    ...
    assert list(G.nodes(data=True))[0][1]["type"] == NODE_TYPE.TILE
...
def test_create_filed_2():
    ...
    assert list(G.nodes(data=True))[1][1]["type"] == NODE_TYPE.TILE
