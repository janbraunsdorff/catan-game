...
def test_trate_ressources_2_1_no_port_claimed(input_, output):
    player = TestPlayer(T.COLOR.BLUE)
    ...
    done = R.post_trate_2_to_1(G, player, input_, output, raise_on_error=False)
...
def test_trate_ressources_2_1_no_port_raise(input_, output):
    player = TestPlayer(T.COLOR.BLUE)
    ...
    with pytest.raises(ValueError) as e:
        R.post_trate_2_to_1(G, player, input_, output, raise_on_error=True)
...
def test_trate_ressources_2_1_no_ressources_claimed(input_, output):
    player = TestPlayer(T.COLOR.BLUE)
...
def test_trate_ressources_2_1_no_ressources_raise(input_, output, port):
    player = TestPlayer(T.COLOR.BLUE)
...
def test_trate_ressources_2_1_other_player_claimed():
    input_ = T.RESSOURCE.Brick
    output = T.RESSOURCE.Grain
...
def test_trate_ressources_2_1_sucessfull_different_ports(input_, output, port):
    player = TestPlayer(T.COLOR.BLUE)
    ...
    done = R.post_trate_2_to_1(G, player, input_, output, raise_on_error=True)
